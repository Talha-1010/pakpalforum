...
export default function AnnouncementBar() {
  ...
  return (
    <div
      className={`duration-350 fixed bottom-4 right-4 z-[60] w-[min(340px,calc(100vw-2rem))] overflow-hidden rounded-2xl shadow-2xl shadow-black/20 transition-all ease-out ${
        cfg.bar
